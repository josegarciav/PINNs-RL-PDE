...
class TestRLAgent(unittest.TestCase):
    ...
    def test_update_epsilon(self):
        ...
        # Test decay formula
        expected_epsilon = max(self.rl_agent.epsilon_end, initial_epsilon * self.rl_agent.epsilon_decay)
    ...
    def test_save_load(self):
        ...
        with tempfile.NamedTemporaryFile() as tmp:
            ...
            for p1, p2 in zip(new_agent.policy_net.parameters(), 
                             self.rl_agent.policy_net.parameters()):
